export const dayOneStr: string = `2qlljdqcbeight
eight47srvbfive
...
export const dayTwoStr: string = `Game 1: 4 green, 2 blue; 1 red, 1 blue, 4 green; 3 green, 4 blue, 1 red; 7 green, 2 blue, 4 red; 3 red, 7 green; 3 red, 3 green
